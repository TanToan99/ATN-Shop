	...
	<div class="row justify-content-center">
		<div class="col-3">
			<div class="category-list">
				<p class="list-group-item cat-item text-left" style="background-color: #e74c3c;color: white">Shops</p>
				<ul class="list-group">
				...
				<form data-category-id="{{$data[0]->category->id}}" id="options">
					<div class="form-group">
						...
						<select class="browser-default custom-select custom-select-md" style="display: inline;" id="pagination-select">
							<option {{ ($page_selection == 10) ? 'selected' : "" }} value="10">Show 10</option>
							<option {{ ($page_selection == 15) ? 'selected' : "" }} value="15">Show 15</option>
							<option {{ ($page_selection == 20) ? 'selected' : "" }} value="20">Show 20</option>
							<option {{ ($page_selection == 25) ? 'selected' : "" }} value="25">Show 25</option>
						</select>
					</div>
					<div class="form-group">
					...
					<div class="product-container container shadow-hover" id="#example">
						<div class="row">
							<div class="col-md-6 col-12">
								...
								<div class="rate">
									@if(!is_null($toys->ratings->avg('star_number')))
									@php
									$average_evalate = $toys->ratings->avg('star_number');
							...
							<div class="col-md-6 col-12">
								<div class="product-info">
									<div class="book-name">
										<a href="{{ route('book',$toys->id) }}"><b></b>{{$toys->name}}</a>
									</div>
									<div class="book-info-panel">
										<div class="book-quantity">
											Remaining: {{$toys->quantity}}
										</div>
										<div class="book-describes">
											Describes : {{substr($toys->describes,0,40)}}...
										</div>
										<button class="get-book-btt" data-book-id="{{$toys->id}}">
											Get it now
										</button>
									</div>
								</div>
