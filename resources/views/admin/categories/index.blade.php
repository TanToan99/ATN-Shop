...
<div class="container">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-cube"></i>&nbsp;Categories</h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-cube fa-lg"></i></li>
      <li class="breadcrumb-item"><a href="{{ route('categories.index') }}">Categories manager</a></li>
    </ul>
  </div>
  <div class="">
    <div class="tile">
      <div class="tile-body">
        <div class="row">
          <div class="col-md-4">
            <a id="create" class="btn btn-xs btn-info"><i class="ace-icon fa fa-plus bigger-120">&nbsp; &nbsp; Add Category</i></a>
    ...
    $(document).on('click', '.update', function(event) {
        ...
        $.ajax({
          ...
          success:function(data) {
            ...
            $('.modal-title').text('Edit Category'); // đổi tên popup create thành edit
