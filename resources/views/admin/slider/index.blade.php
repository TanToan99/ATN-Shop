					...
					<table class="table">
						...
						<tbody>
							...
							<tr data-row="{{$slider->id}}">
								...
								<td><a href="{{route('Slider.Edit', $slider->id)}}" class="btn btn-sm btn-primary">Edit</a>
									<a href="javascript:void(0);" class="btn btn-sm btn-danger slider-remove" data-id="{{$slider->id}}">Delete</a></td>
							</tr>
							@endforeach
						</tbody>
					</table>
