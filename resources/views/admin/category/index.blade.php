...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Shops Manager</li>
        </ol>
    </div><!--/.row-->
    
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Shops Manager</h1>
        </div>
    </div><!--/.row-->
                    ...
                    <table class="table">
                        ...
                        <tbody class="category-content">
                            ...
                            <tr data-row="{{$category->id}}">
                                ...
                                <td class="text-right">
                                    <a href="javascript:void(0);" class="btn btn-sm btn-primary category-newname" data-id="{{$category->id}}">Edit</a>
                                    <a href="javascript:void(0);" class="btn btn-sm btn-danger category-remove" data-id="{{$category->id}}">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
