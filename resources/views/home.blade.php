		...
		<div class="col-12">
			...
			<div class="product-by-category-container">
				<div class="category-name">
					...
					@break
					@default
					<a href="{{ route('category', $toys[0]->category->id) }}">Shop : {{$toys[0]->category->name}}</a>
					@break
					@endswitch
				</div>
						...
						<div class="col-md-11 col-12 book-list">
							...
							<div class="book-item">
								<figure class="book-cover">
									<a href="{{ route('book',$toy->id) }}">
										@if($toy->img == null)
										<img src="{{ asset('images/default.jpg') }}"  alt="Book Image" hr>
										@else
										<img src="{{$toy->img}}" alt="Book Image" hr>
										@endif
									</a>
								</figure>
								...
								<div class="book-info">
									<div class="book-name">
										<a href="{{ route('book',$toy->id) }}">{{$toy->name}}</a>
									</div>
									<div class="book-quantity">
										<p>Remaining: {{$toy->quantity}}</p>
									</div>
									<!-- <div class="book-price">
										<p>{{number_format($toy->price)}} VND</p>
									</div> -->
									<div class="book-buy">
										<button class="get-book-btt" data-book-id="{{$toy->id}}">Get it now</button>
									</div>
									<div class="rate">
										@if($toy->average_rating > 0)
										@php
										$average_evalate = $toy->average_rating;
