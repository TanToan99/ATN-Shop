		...
		<div class="col-7">
			<div class="book-info-container">
				...
				<div class="book-borrow">
					@if($borrow_count >= 1)
					({{$borrow_count}} people buyed this toys !)
					@endif
				</div>
				<hr>
...
<div class="commented-container">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-12">
				<div style="width: 100%;height: 100%;display: flex;justify-content: center;align-items: center">
					...
					<button class="btn btn-success" data-toggle="collapse" data-target="#comment-section">You are commented on this, click here to edit!</button>
					@else
	...
	<div class="user-comment-container" id="user-comment-container">
		...
		<div class="alert alert-warning">
			<li>No Comment, will be the first rating in this !</li>
		</div>
		@endif
	</div>
</div>
