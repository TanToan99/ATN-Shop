		...
		<div id="sidebar-collapse" class="sidebar">
			...
			<form id="options_search" style="padding: 23px;">
				...
				<div class="form-group">
					<label for="category-select">Shop</label>
					...
					<div class="row">
						...
						<div class="col-md-6 col-12">
							<div class="product-info">
								<div class="book-name">
									<a href="{{ route('book',$toy->id) }}"><b></b>{{$toy->name}}</a>
								</div>
								<div class="book-info-panel">
									...
									<div class="book-describes">
										Describes : {{substr($toy->describes,0,40)}}...
									</div>
									<button class="get-book-btt" data-book-id="{{$toy->id}}">
										Get it now
									</button>
								</div>
							</div>
